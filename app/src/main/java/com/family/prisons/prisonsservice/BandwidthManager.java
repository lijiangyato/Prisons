...
public class BandwidthManager {
	...
	private BandwidthManager() {
		// FIXME register Dialogue listener on NetworkManager to get notified of network state
		// FIXME register Dialogue listener on Preference to get notified of change in video enable value
