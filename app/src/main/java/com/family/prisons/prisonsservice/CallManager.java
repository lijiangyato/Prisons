...
public class CallManager {
	...
	public void inviteAddress(LinphoneAddress lAddress, boolean videoEnabled, boolean lowBandwidth, String header) throws LinphoneCoreException {
		...
		//写话单Header头
		params.addCustomHeader("app_myid",header);
	...
	/**
	 * Add video to Dialogue currently running voice only call.
